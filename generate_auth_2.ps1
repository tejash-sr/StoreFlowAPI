...
# CustomUserDetails
Set-Content -Path "$baseDir\security\CustomUserDetails.java" -Value @"
...
Set-Content -Path "$baseDir\security\UserDetailsServiceImpl.java" -Value @"
package com.grootan.storeflow.security;
...
Set-Content -Path "$baseDir\security\JwtAuthenticationFilter.java" -Value @"
package com.grootan.storeflow.security;
...
# SecurityConfig
Set-Content -Path "$baseDir\config\SecurityConfig.java" -Value @"
